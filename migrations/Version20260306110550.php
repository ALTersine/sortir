 ...
 */
final class Version20260306110550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2F577D59B2B59251 ON lieu');
        $this->addSql('ALTER TABLE lieu CHANGE code_postal_id ville_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lieu CHANGE ville_id code_postal_id INT NOT NULL');
        $this->addSql('CREATE INDEX IDX_2F577D59B2B59251 ON lieu (code_postal_id)');
